...
func (this *LegalWalletRechargeController) Recharge(ctx *gin.Context, model *entity.LegalWalletRechargeModel, bindingResult *validation.BindingResult, user *transform.AuthMember) (result *util.MessageResult) {
...
func (this *LegalWalletRechargeController) Page(ctx *gin.Context, pageModel *PageModel.PageModel, screen *screen.LegalWalletScreen, user *transform.AuthMember) (result *util.MessageResult) {
...
func (this *LegalWalletRechargeController) Get(ctx *gin.Context, user *transform.AuthMember, id int64) (result *util.MessageResult) {
