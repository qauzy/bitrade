...
)](https://pkg.go.dev/bitrade/libs/common-lang)
[![Go Report Card](https://goreportcard.com/badge/bitrade/libs/common-lang)](https://goreportcard.com/report/bitrade/libs/common-lang)
...
```shell script
go get bitrade/libs/common-lang
```
...
这个版本的运行效率更高。但是考虑到边界检查的安全性问题，我还是更倾向于传入 list 进来，通过反射来获取列表的长度。相关代码可查看 https://bitrade/libs/common-lang/blob/faster/CollectionUtils/collection_utils.go
...
goos: darwin
goarch: amd64
pkg: bitrade/libs/common-lang/CollectionUtils
