...
type DividendStartRecordDao interface {
	FindAllByTimeAndUnit(start int64, end int64, unit string) (result arraylist.List[entity.DividendStartRecord], err error)
	...
	FindAll(qp *types.QueryParam) (result arraylist.List[*entity.DividendStartRecord], err error)
}
...
func (this *dividendStartRecordDao) FindAllByTimeAndUnit(start int64, end int64, unit string) (result arraylist.List[entity.DividendStartRecord], err error) {
...
func (this *dividendStartRecordDao) FindAll(qp *types.QueryParam) (result arraylist.List[*entity.DividendStartRecord], err error) {
	d := this.DBRead()
	if qp != nil {
		d = qp.BuildQuery(d)
	}
