...
type MemberApiKeyDao interface {
	...
	FindAllByMemberId(memberId int64) (result []entity.MemberApiKey, err error)
	FindMemberApiKeyByMemberIdAndId(memberId int64, id int64) (result entity.MemberApiKey, err error)
	Del(id int64) (result int64, err error)
	...
	FindAll(qp *types.QueryParam) (result []*entity.MemberApiKey, err error)
}
...
func (this *memberApiKeyDao) FindAllByMemberId(memberId int64) (result []entity.MemberApiKey, err error) {
...
func (this *memberApiKeyDao) Del(id int64) (result int64, err error) {
...
func (this *memberApiKeyDao) FindAll(qp *types.QueryParam) (result []*entity.MemberApiKey, err error) {
	d := this.DBRead()
	if qp != nil {
		d = qp.BuildQuery(d)
	}
