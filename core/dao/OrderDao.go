...
type OrderDao interface {
	GetOrderByMemberIdAndOrderSn(memberId int64, orderSn string) (result []entity.Order, err error)
	GetOrderByMemberId(memberId int64) (result []entity.Order, err error)
	GetOrderByMemberIdAndStatus(memberId int64, status OrderStatus.OrderStatus) (result []entity.Order, err error)
	GetOrderByMemberIdAndStatusAndOrderSn(memberId int64, status OrderStatus.OrderStatus, orderSn string) (result []entity.Order, err error)
	FindByAdvertiseId(advertiseId int64) (result []entity.Order, err error)
	...
	FindAllExpiredOrder(date time.Time) (result []entity.Order, err error)
	FingAllProcessingOrder(myId int64, unPay OrderStatus.OrderStatus, paid OrderStatus.OrderStatus, appeal OrderStatus.OrderStatus) (result []entity.Order, err error)
	...
	GetOtcTurnoverAmount(date string) (result [][]interface{}, err error)
	GetBusinessStatistics(memberId int64) (result map[string]interface {
	}, err error)
	CancelNopaymentOrder(date time.Time, status OrderStatus.OrderStatus, orderSn string) (result int, err error)
	CountOrdersByMemberIdAndCreateTime(startTime time.Time, endTime time.Time) (result [][]interface{}, err error)
	Save(m *entity.Order) (result *entity.Order, err error)
	FindById(id int64) (result *entity.Order, err error)
	DeleteById(id int64) (count int64, err error)
	FindAll(qp *types.QueryParam) (result []*entity.Order, err error)
}
...
func (this *orderDao) GetOrderByMemberIdAndOrderSn(memberId int64, orderSn string) (result []entity.Order, err error) {
	return
}

func (this *orderDao) GetOrderByMemberId(memberId int64) (result []entity.Order, err error) {
	return
}
func (this *orderDao) GetOrderByMemberIdAndStatus(memberId int64, status OrderStatus.OrderStatus) (result []entity.Order, err error) {
	return
}
func (this *orderDao) GetOrderByMemberIdAndStatusAndOrderSn(memberId int64, status OrderStatus.OrderStatus, orderSn string) (result []entity.Order, err error) {
	return
}
func (this *orderDao) FindByAdvertiseId(advertiseId int64) (result []entity.Order, err error) {
...
func (this *orderDao) FindAllExpiredOrder(date time.Time) (result []entity.Order, err error) {
...
func (this *orderDao) FingAllProcessingOrder(myId int64, unPay OrderStatus.OrderStatus, paid OrderStatus.OrderStatus, appeal OrderStatus.OrderStatus) (result []entity.Order, err error) {
...
func (this *orderDao) GetOtcTurnoverAmount(date string) (result [][]interface{}, err error) {

	//FIXME 非原生sql，需要处理
	eng := this.DBWrite().Exec("select a.unit unit,date_format(b.release_time,'%Y-%m-%d'), sum(b.number) amount ,sum(b.commission) fee ,sum(money) from otc_order b ,otc_coin a where a.id = b.coin_id and b.status = 3 and date_format(b.release_time,'%Y-%m-%d') = ? group by a.unit", date)
	err = eng.Error
	return
}
func (this *orderDao) GetBusinessStatistics(memberId int64) (result map[string]interface {
}, err error) {
...
func (this *orderDao) CountOrdersByMemberIdAndCreateTime(startTime time.Time, endTime time.Time) (result [][]interface{}, err error) {
...
func (this *orderDao) FindAll(qp *types.QueryParam) (result []*entity.Order, err error) {
	d := this.DBRead()
	if qp != nil {
		d = qp.BuildQuery(d)
	}
