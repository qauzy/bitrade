...
type AdminDao interface {
	...
	FindAllByDepartment(department entity.Department) (result []entity.Admin, err error)
	FindAllByRoleId(id int64) (result []entity.Admin, err error)
	FindByUsername(username string) (result entity.Admin, err error)
	FindByMobilePhone(mobilePhone string) (result []entity.Admin, err error)
	Save(m *entity.Admin) (result *entity.Admin, err error)
	FindById(id int64) (result *entity.Admin, err error)
	DeleteById(id int64) (count int64, err error)
	FindAll(qp *types.QueryParam) (result []*entity.Admin, err error)
}
...
func (this *adminDao) FindAllByDepartment(department entity.Department) (result []entity.Admin, err error) {
	err = this.DBRead().Where("department = ?", department).Find(&result).Error
	return
}
func (this *adminDao) FindAllByRoleId(id int64) (result []entity.Admin, err error) {
...
func (this *adminDao) FindByMobilePhone(mobilePhone string) (result []entity.Admin, err error) {
...
func (this *adminDao) FindAll(qp *types.QueryParam) (result []*entity.Admin, err error) {
	d := this.DBRead()
	if qp != nil {
		d = qp.BuildQuery(d)
	}
