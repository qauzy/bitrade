...
type LockPositionRecordDao interface {
	FindByStatusAndUnlockTime(status CommonStatus.CommonStatus, unlockTime time.Time) (result []entity.LockPositionRecord, err error)
	UnlockById(id int64, status CommonStatus.CommonStatus) (err error)
	UnlockByIds(ids []int64, status CommonStatus.CommonStatus) (err error)
	FindByMemberIdAndCoinAndStatus(memberId int64, coin entity.Coin, status CommonStatus.CommonStatus) (result []entity.LockPositionRecord, err error)
	...
	FindAll(qp *types.QueryParam) (result []*entity.LockPositionRecord, err error)
}
...
func (this *lockPositionRecordDao) FindByStatusAndUnlockTime(status CommonStatus.CommonStatus, unlockTime time.Time) (result []entity.LockPositionRecord, err error) {
...
func (this *lockPositionRecordDao) UnlockByIds(ids []int64, status CommonStatus.CommonStatus) (err error) {
...
func (this *lockPositionRecordDao) FindByMemberIdAndCoinAndStatus(memberId int64, coin entity.Coin, status CommonStatus.CommonStatus) (result []entity.LockPositionRecord, err error) {
...
func (this *lockPositionRecordDao) FindAll(qp *types.QueryParam) (result []*entity.LockPositionRecord, err error) {
	d := this.DBRead()
	if qp != nil {
		d = qp.BuildQuery(d)
	}
