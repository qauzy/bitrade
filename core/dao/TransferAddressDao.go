...
type TransferAddressDao interface {
	FindAllByStatusAndCoin(status CommonStatus.CommonStatus, coin entity.Coin) (result []entity.TransferAddress, err error)
	...
	FindAll(qp *types.QueryParam) (result []*entity.TransferAddress, err error)
}
...
func (this *transferAddressDao) FindAllByStatusAndCoin(status CommonStatus.CommonStatus, coin entity.Coin) (result []entity.TransferAddress, err error) {
...
func (this *transferAddressDao) FindAll(qp *types.QueryParam) (result []*entity.TransferAddress, err error) {
	d := this.DBRead()
	if qp != nil {
		d = qp.BuildQuery(d)
	}
