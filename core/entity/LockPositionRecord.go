...
func (this *LockPositionRecord) SetStatus(status constant.CommonStatus) (result *LockPositionRecord) {
	this.Status = status
	return this
}
func (this *LockPositionRecord) GetStatus() (status constant.CommonStatus) {
	return this.Status
}
